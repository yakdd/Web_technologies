            ...
            <div class="w3-twothird">                
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <?php for($i = 0; $i < count($experience); $i++):?>
                        <div class="w3-container">
                            <h5 class="w3-opacity"><b><?php echo $experience[$i]['post'];?></b></h5>
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                        	<?php echo $experience[$i]['date_start'];?>
                            -
                            <?php
                                if ($experience[$i]['date_finish'])
                                    {echo $experience[$i]['date_finish'];}
                                else {echo ' <span class="w3-tag w3-teal w3-round">Current</span>';}                            
                            ?>
                            </h6>
